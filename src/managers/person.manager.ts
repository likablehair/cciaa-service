...
export class PersonManager {
  public async mapPersonaDataToCorporateRoles(params: {
    ...
    const personSummary: PersonSummary = {
      ...
      lastname: bloccoPersona["dati-identificativi-persona"]?.['cognome'] || null,
      gender: bloccoPersona["dati-identificativi-persona"]?.['sesso'] || null,
      fiscalCode: bloccoPersona["dati-identificativi-persona"]?.['c-fiscale'] || null,
      dateOfBirth: parseUnknownDate(
        bloccoPersona["dati-identificativi-persona"]?.["estremi-nascita"]?.dt,
      ),
      municipality: bloccoPersona["dati-identificativi-persona"]?.["estremi-nascita"]?.comune || null,
      province: bloccoPersona["dati-identificativi-persona"]?.["estremi-nascita"]?.provincia || null,
      address: bloccoPersona["dati-identificativi-persona"]?.indirizzo ? `${bloccoPersona["dati-identificativi-persona"].indirizzo.via} ${bloccoPersona["dati-identificativi-persona"].indirizzo['n-civico']}` : null,
    ...
    for (const impresa of imprese) {
      ...
      for (const carica of caricheArray) {
        const companySummary: CompanySummary = {
          ...
          companyFiscalCode: impresa['dati-identificativi-impresa']['c-fiscale'],
          companyVatNumber: impresa['dati-identificativi-impresa']['c-fiscale'],
          companyLegalFormCode: impresa['dati-identificativi-impresa']['forma-giuridica']?.c || '',
          companyLegalFormDescription: impresa['dati-identificativi-impresa']['forma-giuridica']?.['#text'] || '',
          companyCciaaCode: impresa['dati-identificativi-impresa']['cciaa'],
          companyCciaaDescription: '', // Non disponibile in AnagraficaImpresa
          companyReaNumber: parseInt(impresa['dati-identificativi-impresa']['n-rea'], 10) || 0,
          ...
          companySourceCode: impresa['dati-identificativi-impresa']['c-fonte'] || '',
          companySourceDescription: impresa['dati-identificativi-impresa']['fonte'] || '',
          companyDeclaredActivity: impresa['info-attivita']?.["classificazioni-ateco"]?.["classificazione-ateco"] 
            ? (
                Array.isArray(impresa['info-attivita']?.["classificazioni-ateco"]?.["classificazione-ateco"]) 
                  ? impresa['info-attivita']?.["classificazioni-ateco"]?.["classificazione-ateco"][0]?.attivita 
                  : impresa['info-attivita']?.["classificazioni-ateco"]?.["classificazione-ateco"]?.attivita
              ) 
            : '',
          companyAtecoCode: impresa['info-attivita']?.['classificazioni-ateco']?.['c-codifica'] || '',
          companyAtecoDescription: impresa['info-attivita']?.['classificazioni-ateco']?.codifica || '',
          companyAtecoClassificationCode: parseInt(impresa['info-attivita']?.['classificazioni-ateco']?.['c-codifica'] || '0', 10) || 0,
          companyAtecoClassificationDescription: impresa['info-attivita']?.['classificazioni-ateco']?.codifica || '',
          companyProvinceCode: impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.provincia || '',
          companyProvinceDescription: '', // Non disponibile in AnagraficaImpresa
          companyMunicipalityCode: impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.['c-comune'] || '',
          companyMunicipalityDescription: '', // Non disponibile in AnagraficaImpresa
          companyToponymCode: impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.['c-toponimo'] || '',
          companyToponymDescription: '', // Non disponibile in AnagraficaImpresa
          companyStreet: impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.['via'] || '',
          companyStreetNumber: impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.['n-civico'] || '',
          companyPostalCode: parseInt(impresa['dati-identificativi-impresa']['indirizzo-localizzazione']?.['cap'] || '0', 10) || 0,
          companyPec: impresa['dati-identificativi-impresa']['indirizzo-posta-certificata'] || '',
        ...
        personSummary.pec = impresa.persona?.["indirizzo-posta-certificata"] || personSummary.pec;
        ...
        corporateRoles.push({
          ...
          balanceSheetDate: parseUnknownDate(
            carica['dt-riferimento-bilancio'],
          ),
          aiwsError: null,
        });
      }
