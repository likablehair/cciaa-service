import { CompanyShare, CompanyShareType } from 'src/types/companies-register/company.types';
import { Indirizzo, Riquadro } from 'src/types/companies-register/share.type';
